...
import { createProduct, ProductItemType } from '../../../../store/productsSlice'
            ...
            <div className="form__left">
              ...
              {imgUrl && (
                <div className="img__item">
                  ...
                  <img src={(process.env.REACT_APP_SERVER_URL || '') + imgUrl} alt="фото" />
                </div>
              )}
                ...
                {galleryUrl &&
                  galleryUrl.map((item) => (
                    <div key={item} className="img__item">
                      ...
                      <img src={(process.env.REACT_APP_SERVER_URL || '') + item} alt="фото" />
                    </div>
                  ))}
              </div>
